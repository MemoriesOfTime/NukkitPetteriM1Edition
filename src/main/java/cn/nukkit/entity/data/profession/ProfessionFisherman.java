    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.STRING,0,20), Item.get(Item.EMERALD))
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD,0,3), Item.get(Item.BUCKET, 2))
                        ...
                        .setTraderExp(2)
                        .build())
                /*.add(RecipeBuildUtils.of(Item.get(Item.EMERALD), MinecraftItemID.COD.get(6), MinecraftItemID.COOKED_COD.get(6))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(2)
                ...
                .add(RecipeBuildUtils.of(MinecraftItemID.COD.get(15), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(2)
                        .build())*/
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 2), Item.get(Item.CAMPFIRE))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(2)
                        .build())
                /*.add(RecipeBuildUtils.of(Item.get(Item.EMERALD), MinecraftItemID.SALMON.get(5), MinecraftItemID.COOKED_SALMON.get(6))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(2)
